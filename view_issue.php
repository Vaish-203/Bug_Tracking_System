...
<div class="row justify-content-end px-3 mb-2">
    <?php if(($_SESSION['type'] == 1 || $_SESSION['department_id'] == $res['department_id']) && $res['status'] == 0): ?>
        <button class="btn btn-sm btn-primary me-2 close_issue rounded-0 col-auto" type="button" data-id= '<?php echo $res['issue_id'] ?>' >Close Bug</button>
    <?php endif; ?>
    <?php if($_SESSION['type'] == 1 || $_SESSION['user_id'] == $res['user_id']): ?>
        <button class="btn btn-sm btn-danger delete_data rounded-0 col-auto" type="button" data-id= '<?php echo $res['issue_id'] ?>' >Delete Bug</button>
    <?php endif; ?>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body pb-4">
                <h4><b>Bug: <?php echo $res['title'] ?></b></h4>
                <div class="row">
                    <div class="col-sm-6"> 
